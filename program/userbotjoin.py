...
async def join_group(client, message):
    ...
    try:
        ...
        await message.reply_text(
            ...
            "\n\n**قم بتوجيه الرساله الي مالك البوت @G8AZAAL أو أضف مساعدًا @MC_THOR  يدويًا إلى مجموعتك وحاول مرة أخرى**",
        )
        return
    await message.reply_text(
...
@Client.on_message(command(["userbotleave","ادرونا","غادورا",
...
@Client.on_message(command(["leaveall","ميع غدوور","غادورانا", f"leaveall@{BOT_USERNAME}"]))
@sudo_users_only
