...
@Client.on_message(command(["update","رقيوقه",  f"update@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
...
@Client.on_message(command(["restart","نصبرون",  f"restart@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
